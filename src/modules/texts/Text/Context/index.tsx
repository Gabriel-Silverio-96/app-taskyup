...
import { IContextText, IContextProviderText, IDialogDeleteSingleText, IDialogDeleteAllText } from "./types/ContextText";
...
export const ContextProviderText: React.FC<IContextProviderText> = ({ children }) => {
...
export const useContextText = () => {
	...
	if(context === undefined) {
		throw new Error("useContextText must be used within a ContextProviderText");
	}
